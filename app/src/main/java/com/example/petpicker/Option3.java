/**
 * Page for additional information (video & leads to locations for resources/adoption) for the 3rd recommended pet.
...
public class Option3 extends YouTubeBaseActivity {
    ...
    /**
     * ID of YouTube video for the 3rd recommended pet
     */
    String currentId;
    ...
    /**
     * Information (video and leads to map) about 3rd recommended pet when activity is opened
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /**
         * Assigns the currentID to the 3rd recommended pet
         */
    ...
    /**
     * Opens the map activity that corresponds with the 3rd recommended pet
     */
    public void openMap()
    {
