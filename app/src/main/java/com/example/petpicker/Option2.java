/**
 * Page for additional information (video & leads to locations for resources/adoption) for the 2nd recommended pet.
...
public class Option2 extends YouTubeBaseActivity {
    ...
    /**
     * ID of YouTube video for the 2nd recommended pet
     */
    String currentId;
    ...
    /**
     * Information (video and leads to map) about 2nd recommended pet when activity is opened
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /**
         * Assigns the currentID to the 2nd recommended pet
         */
    ...
    /**
     * Opens the map activity that corresponds with the 2nd recommended pet
     */
    public void openMap()
    {
