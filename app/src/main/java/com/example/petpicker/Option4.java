/**
 * Page for additional information (video & leads to locations for resources/adoption) for the 4th recommended pet.
...
public class Option4 extends YouTubeBaseActivity {
    ...
    /**
     * ID of YouTube video for the 4th recommended pet
     */
    String currentId;
    ...
    /**
     * Information (video and leads to map) about 4th recommended pet when activity is opened
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /**
         * Assigns the currentID to the 4th recommended pet
         */
    ...
    /**
     * Opens the map activity that corresponds with the 4th recommended pet
     */
    public void openMap()
    {
