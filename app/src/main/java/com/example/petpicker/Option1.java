/**
 * Page for additional information (video & leads to locations for resources/adoption) for the 1st recommended pet.
...
public class Option1 extends YouTubeBaseActivity {
    ...
    /**
     * ID of YouTube video for the 1st recommended pet
     */
    String currentId;
    ...
    /**
     * Information (video and leads to map) about 1st recommended pet when activity is opened
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /**
         * Assigns the currentID to the 1st recommended pet
         */
    ...
    /**
     * Opens the map activity that corresponds with the 1st recommended pet
     */
    public void openMap()
    {
