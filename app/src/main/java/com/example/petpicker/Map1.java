/**
 * Searches and displays nearby pet resources (based on current location) for the 1st recommended pet using Google Maps.
    ...
    public void findPets(View v)
    {
        ...
        if (ActivityCompat.checkSelfPermission(Map1.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED)
        {
            fusedLocationProviderClient.getLastLocation().addOnCompleteListener(new OnCompleteListener<Location>() {
                ...
                /**
                 * Utilizes user specified radius and current location to search for the 1st recommended pet locations
                 * @param task
                 */
                @Override
